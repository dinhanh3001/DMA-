...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/System_rsp_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/System_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/System_cmd_xbar_mux_001.sv \
  $QSYS_SIMDIR/submodules/System_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/System_cmd_xbar_demux_002.sv \
  $QSYS_SIMDIR/submodules/System_cmd_xbar_demux_001.sv \
  $QSYS_SIMDIR/submodules/System_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/System_id_router_004.sv \
  $QSYS_SIMDIR/submodules/System_id_router_002.sv \
  $QSYS_SIMDIR/submodules/System_id_router_001.sv \
  $QSYS_SIMDIR/submodules/System_id_router.sv \
  $QSYS_SIMDIR/submodules/System_addr_router_003.sv \
  $QSYS_SIMDIR/submodules/System_addr_router_002.sv \
  ...
  $QSYS_SIMDIR/submodules/DMAFinal.v \
  $QSYS_SIMDIR/submodules/control_slave.v \
  $QSYS_SIMDIR/submodules/FIFO.v \
  $QSYS_SIMDIR/submodules/read_master.v \
  $QSYS_SIMDIR/submodules/write_master.v \
  $QSYS_SIMDIR/submodules/System_onchip_memory2_1.v \
