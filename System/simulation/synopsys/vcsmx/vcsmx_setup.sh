...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_cmd_xbar_mux_001.sv"                      -work cmd_xbar_mux_001                                                                 
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_cmd_xbar_demux_002.sv"                    -work cmd_xbar_demux_002                                                               
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_id_router_004.sv"                         -work id_router_004                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_id_router_002.sv"                         -work id_router_002                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_id_router_001.sv"                         -work id_router_001                                                                    
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_id_router.sv"                             -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_addr_router_003.sv"                       -work addr_router_003                                                                  
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/System_addr_router_002.sv"                       -work addr_router_002                                                                  
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/DMAFinal.v"                                      -work DMA_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/control_slave.v"                                 -work DMA_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/FIFO.v"                                          -work DMA_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/read_master.v"                                   -work DMA_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/write_master.v"                                  -work DMA_0                                                                            
  vlogan +v2k           "$QSYS_SIMDIR/submodules/System_onchip_memory2_1.v"                       -work onchip_memory2_1                                                                 
