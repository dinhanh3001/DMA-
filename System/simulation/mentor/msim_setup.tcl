...
alias com {
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/System_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/System_cmd_xbar_mux_001.sv"                      -work cmd_xbar_mux_001                                                                 
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/System_cmd_xbar_demux_002.sv"                    -work cmd_xbar_demux_002                                                               
  ...
  vlog -sv "$QSYS_SIMDIR/submodules/System_id_router_004.sv"                         -work id_router_004                                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/System_id_router_002.sv"                         -work id_router_002                                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/System_id_router_001.sv"                         -work id_router_001                                                                    
  vlog -sv "$QSYS_SIMDIR/submodules/System_id_router.sv"                             -work id_router                                                                        
  vlog -sv "$QSYS_SIMDIR/submodules/System_addr_router_003.sv"                       -work addr_router_003                                                                  
  vlog -sv "$QSYS_SIMDIR/submodules/System_addr_router_002.sv"                       -work addr_router_002                                                                  
...
alias elab_debug {
  ...
  vsim -novopt -t ps -L work -L work_lib -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_001 -L rsp_xbar_demux -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_004 -L id_router_002 -L id_router_001 -L id_router -L addr_router_003 -L addr_router_002 -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L DMA_0 -L onchip_memory2_1 -L jtag_uart_0 -L nios2_qsys_0 -L onchip_memory2_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
