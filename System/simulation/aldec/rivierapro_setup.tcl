...
# ACDS 13.0sp1 232 win32 2025.12.23.15:33:53
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/System_onchip_memory2_1.hex ./
...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/System_rsp_xbar_demux_001.sv"                    -work rsp_xbar_demux_001                                                               
  vlog  "$QSYS_SIMDIR/submodules/System_rsp_xbar_demux.sv"                        -work rsp_xbar_demux                                                                   
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux_001                                                                 
  vlog  "$QSYS_SIMDIR/submodules/System_cmd_xbar_mux_001.sv"                      -work cmd_xbar_mux_001                                                                 
  ...
  vlog  "$QSYS_SIMDIR/submodules/System_cmd_xbar_demux_002.sv"                    -work cmd_xbar_demux_002                                                               
  ...
  vlog  "$QSYS_SIMDIR/submodules/System_id_router_004.sv"                         -work id_router_004                                                                    
  vlog  "$QSYS_SIMDIR/submodules/System_id_router_002.sv"                         -work id_router_002                                                                    
  vlog  "$QSYS_SIMDIR/submodules/System_id_router_001.sv"                         -work id_router_001                                                                    
  vlog  "$QSYS_SIMDIR/submodules/System_id_router.sv"                             -work id_router                                                                        
  vlog  "$QSYS_SIMDIR/submodules/System_addr_router_003.sv"                       -work addr_router_003                                                                  
  vlog  "$QSYS_SIMDIR/submodules/System_addr_router_002.sv"                       -work addr_router_002                                                                  
  ...
  vlog  "$QSYS_SIMDIR/submodules/DMAFinal.v"                                      -work DMA_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/control_slave.v"                                 -work DMA_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/FIFO.v"                                          -work DMA_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/read_master.v"                                   -work DMA_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/write_master.v"                                  -work DMA_0                                                                            
  vlog  "$QSYS_SIMDIR/submodules/System_onchip_memory2_1.v"                       -work onchip_memory2_1                                                                 
...
alias elab {
  echo "\[exec\] elab"
  vsim +access +r  -t ps -L work -L irq_mapper -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_001 -L rsp_xbar_demux -L cmd_xbar_mux_001 -L cmd_xbar_mux -L cmd_xbar_demux_002 -L cmd_xbar_demux_001 -L cmd_xbar_demux -L rst_controller -L id_router_004 -L id_router_002 -L id_router_001 -L id_router -L addr_router_003 -L addr_router_002 -L addr_router_001 -L addr_router -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_qsys_0_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_qsys_0_instruction_master_translator_avalon_universal_master_0_agent -L nios2_qsys_0_jtag_debug_module_translator -L nios2_qsys_0_instruction_master_translator -L DMA_0 -L onchip_memory2_1 -L jtag_uart_0 -L nios2_qsys_0 -L onchip_memory2_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneii_ver $TOP_LEVEL_NAME
}
